...
export const MonthLabelWrapper = styled.div<MonthLabelWrapperProps>`
  ...
  align-items: center;
  width: 100%;
  height: ${(props: MonthLabelWrapperProps) => props.height || '100%'};
  ${(props: MonthLabelWrapperProps) => {
    if (props.alignment === 'left') return 'margin-right: 2px;';
    else if (props.alignment === 'right') return 'margin-left: 2px;';
    return '';
  }}
