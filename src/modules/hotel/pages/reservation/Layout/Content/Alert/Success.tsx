            ...
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <Alert severity="success" variant="filled" className={classes.alert}>
                        <AlertTitle style={{ fontSize: FontManager.default.TEXT_EXTRA_24, marginBottom: 0, }}>{i18n.t('credit.card.payment.result.navigation.title.success')}</AlertTitle>
