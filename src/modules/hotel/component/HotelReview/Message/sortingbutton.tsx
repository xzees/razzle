            ...
            <>
                <ToggleButtonGroup style={{width: '100%'}} ref={targetRef} >
                    <styles.MyToggleButton aria-controls="menu-review-sorting" aria-haspopup="true" onClick={handleClickE} ref={targetRef}>
                        <FilterListIcon style={{color: ColorManager.default.fourthColor}} />
                        <styles.MyListItemText primary={i18n.t('hotel.components.hotelreview.message.sortingbutton.lblsort')} 
                        secondary={i18n.t('hotel.components.hotelreview.message.filterbutton.lblreview')}
                        isMobile={isMobile} />
