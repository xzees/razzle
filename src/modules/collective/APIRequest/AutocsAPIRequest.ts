...
class AutocsAPIRequest implements APIRequestInterface {

  method: HTTPMethodEnum = HTTPMethodEnum.GET
  url: string = APIConfig.collective.autoCompleteDev
  ...
  constructor(query: { keyword: string }) {
    this.url = this.url + '/' + encodeURI( query.keyword)
  }
...
export default AutocsAPIRequest