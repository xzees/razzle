...
const DesktopContact = (props: Props) => {
  const {
    category,
    toggleDrawer
  } = props;
  ...
  return (
    <ButtomBottom>
      ...
      <ButtonContact className="booShake" rel="noreferrer" href="tel:021719999" target="_blank" id="icon-tl-d-phone" >
      ...
      <ButtonContact className="booShake" rel="noreferrer" href="https://m.me/thaitravelcenter" target="_blank" id="icon-tl-d-facebook" >
      ...
      <ButtonContact className="booShake" rel="noreferrer" href="https://line.me/ti/p/@thaitravelcenter" target="_blank" id="icon-tl-d-line" >
...
const ButtomBottom = styled.div`
  ...
  bottom: 0;
  border: 2px solid ${ColorManager.default.greyColor};
  ...
  a.booShake:hover svg, a.booShake:hover img {
    animation: boo-shake 2s linear infinite;
  }
  svg {
...
const ButtonDiv = styled.div`
  border-bottom: 2px solid ${ColorManager.default.greyColor};
  cursor: pointer;
  display: block;
  height: 60px;
  padding: 10px 0;
