...
`
export const CaptionImg = styled.div`
...
export const BoxTourContent = styled.div`
  ...
  @media (min-width: 600px) and (max-width: 652px) {
    .Tour-Name {
      max-width: 70%;
      flex-basis: 70%;
    }
...
export const TourTitle = {
  ...
  color: ColorManager.default.primaryColor,
  fontFamily: FontManager.default.secondaryFont,
  fontSize: ['1.5625rem', '1.5625rem', '27px', '27px', '27px'],
  fontWeight: 'normal',
  lineHeight: 0.9,
  mb: '10px',
}
...
export const TourPrice = {
  ...
  display: 'block',
  fontFamily: FontManager.default.secondaryFont,
  fontSize: ['31px', '31px', '41px', '41px', '41px'],
  fontWeight: 'normal',
  lineHeight: 0.6,
  mb: '0',
}
