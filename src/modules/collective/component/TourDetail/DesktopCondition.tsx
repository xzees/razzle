...
import { h2Style, BoxCondition, CondTitle, IconCond, ExCondPanel, ExCondTab, ExCondTitle, ExCondDetail } from './Desktop.style';
...
const DesktopCondition = inject("stores")(
        ...
        {tourDetail?.remarks ? (
          <>
            {tourDetail?.remarks.include.length > 0 ? (
              <ExCondPanel onClick={handleTabToggle} className="tabOpen">
                <ExCondTab>
...
export default DesktopCondition;